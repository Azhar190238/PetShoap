...
//                             <div className='flex'>
//                                 <div className='bg-[#38C5D9] flex justify-center items-center rounded-full w-[240px] relative h-[400px]'>
//                                     <img src="/src/assets/image/LookingFor/3.png" alt="Puppy 2" className='!w-[320px] !h-[450px] absolute bottom-1 -left-2' />
//                                 </div>
//                             </div>
...
//                             <img src="/src/assets/image/ShopPate/koma.png" alt="" className=' absolute -left-14 top-8 !w-[56px] !h-[56px] ' />
